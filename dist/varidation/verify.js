...
var UserVerify = /*#__PURE__*/function () {
  ...
  return _createClass(UserVerify, null, [{
    key: "validateEmail",
    ...
    value: function verifyStrongPassword(password) {
      ...
      var isStrong = password.length >= minLength && password.length <= maxLength && hasUpperCase && hasLowerCase && hasNumbers && hasSpecialChars;
      return isStrong;
    }
  }, {
    key: "verifyId",
    value: function verifyId(idNo) {
      return idNo.length === 16;
    }
  }]);
}();
var _default = exports["default"] = UserVerify;